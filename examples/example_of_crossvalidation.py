...
mca.plot(save_fig=True, cmap='viridis', name=MCA_PLOT_NAME, folder=PLOTS_FOLDER, suy_ticks=[-0.25, -0.125, 0, 0.125, 0.25], suz_ticks=[-0.15, -0.075, 0, 0.075, 0.15])
...
# plot_crossvalidation_elena(cross, folder=PLOTS_FOLDER, name='plot-elena.png')
